...
public class SwaggerConfig {
	...
	private ApiInfo metaData() {
		return new ApiInfoBuilder().title("APIs created for findbybug.com").description("Api Documentation")
				.version("1.0").contact(new Contact("devteam", "developers.findbybug.com", "devteam@findbybug.com"))
				.build();
	}
